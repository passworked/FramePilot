...
class MainWindow(QMainWindow):
    ...
    def tr(self, text_or_key: str) -> str:
        return LOCALIZER.translate(text_or_key, self.language)

    def trf(self, text_or_key: str, **values: object) -> str:
        return LOCALIZER.format(text_or_key, self.language, **values)

    def localize_message(self, message: str | LocalizedMessage) -> str:
